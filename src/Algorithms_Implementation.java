public class Algorithms_Implementation {

        public static void main(String[] args) {
            Integer[] integers = {12, 5, 233, 53, 688, 1, 2};
        ...
        public static <T> void genericArray(T[] elements) {
...
// (11) Given a sorted array and a number x, find the pair in
